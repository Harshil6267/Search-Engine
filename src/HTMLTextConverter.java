...
//This method converts HTML Files into text documents.
	public static void convertHtmlToText()
		...
		try {
			File dir = new File("C:\\Users\\user\\eclipse-workspace\\SearchEngine\\W3C Web Pages");
			File[] fileArray = dir.listFiles();
			for (File file : fileArray) {
				doc = Jsoup.parse(file, "UTF-8");
				String str = file.getName().substring(0, file.getName().lastIndexOf('.'));
				out = new BufferedWriter(
						new FileWriter("C:\\Users\\user\\eclipse-workspace\\SearchEngine\\src\\ConvertedTextFiles\\"
								+ str  + ".txt"));
				out.write(doc.text());
				out.close();
